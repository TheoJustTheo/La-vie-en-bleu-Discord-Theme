...
--bonfire: url('https://media.discordapp.net/attachments/801101082596081684/822944084091338812/wompus_wompus.gif');
...
.winButtonMinMax-PBQ2gm:nth-child(3):after { background-color: #6E85D3; padding: 5px;}
.winButtonMinMax-PBQ2gm:nth-child(3):hover::after { background-color: #6E85D3;}

.winButtonMinMax-PBQ2gm:last-child { color: #6E85D3;}
.winButtonMinMax-PBQ2gm:last-child:hover { color: #6E85D3;}
...
/* Comfy camp server */
[src="https://cdn.discordapp.com/icons/811203761619337259/0564a75bda132490421a8d4cccb0ea1c.webp?size=128"] { content: url('https://media.discordapp.net/attachments/801101082596081684/822944084091338812/wompus_wompus.gif');}
.listItem-2P_4kh:hover .icon-27yU2q[src*="https://cdn.discordapp.com/icons/811203761619337259/0564a75bda132490421a8d4cccb0ea1c"] { content: url('https://media.discordapp.net/attachments/801101082596081684/822944084091338812/wompus_wompus.gif');}
...
.theme-light {
    ...
    --background-primary: #1B1F25;
    --background-secondary: #171A1F;
    --background-tertiary: #171A1F;
    --background-accent: #171A1F;
    --background-floating: rgba(23, 26, 31,0);
    --activity-card-background: #171A1F;
    --deprecated-panel-background: #171A1F;
}
`;
